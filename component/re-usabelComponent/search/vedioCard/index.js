      ...
      <div className="vedio_text">
        ...
        <div className="text">
          <Space direction="vertical" size={4}>
            <div className="head">{text1}</div>
            <div className="color_text">{text2}</div>
            <Space size={5}>
              <div className="heading">{text3}</div>
              <div>
                <svg
                  width="12"
                  height="13"
            ...
            <Space>
              <div className="color_text rigth">{views}</div>
              <div className="color_text rigth">{time}</div>
              <div className="color_text ">{likes}</div>
            </Space>
          </Space>
        </div>
      </div>
