...
export default function GroupCard({ profile, text1 }) {
  return (
    <div className="group_card">
      ...
      <div className="bottom">
        <Space direction="vertical" size={0}>
          ...
          <Space size={5}>
            <div className="color_text rigth">page</div>
            <div className="color_text">2m Like this</div>
          </Space>
        </Space>

        <SeeAllButton text="Like" className="group see_button" />
      </div>
    </div>
  );
}
